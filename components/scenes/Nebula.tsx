...
export default function Nebula({ light }: SceneProps) {
  ...
  const clouds = [
    { color: "var(--accent-from)", className: "-top-1/4 -left-[15%] h-[40rem] w-[40rem]", delay: "0s" },
    { color: "var(--accent-to)", className: "-top-[10%] right-[-12%] h-[36rem] w-[36rem]", delay: "-6s" },
    { color: "var(--accent-from)", className: "top-1/4 left-1/3 h-[30rem] w-[30rem]", delay: "-12s" },
    { color: "var(--accent-to)", className: "bottom-[-18%] left-[8%] h-[34rem] w-[34rem]", delay: "-18s" },
    { color: "var(--accent-from)", className: "bottom-[-12%] right-1/4 h-[28rem] w-[28rem]", delay: "-24s" },
    { color: "var(--accent-to)", className: "top-[42%] left-1/2 h-[22rem] w-[22rem]", delay: "-30s" },
    { color: "var(--accent-from)", className: "top-[8%] left-[42%] h-[18rem] w-[18rem]", delay: "-15s" },
  ];
  return (
    <div
      aria-hidden
